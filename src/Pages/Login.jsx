        ...
        <div className=" w-full overflow-hidden rounded-xl   flex justify-center items-center   lg:h-[80%] ">
          ...
          <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%]">
            ...
            <form className="flex  w-full flex-col items-center justify-center gap-4">
              ...
              <button  className="btn w-[80%] rounded-lg bg-[#8EA7E9] px-6 py-2 font-medium text-white md:w-[60%]" >Login</button>
            </form>
              <div className="flex items-center pt-4 space-x-2">
            <div className="flex-1 h-px bg-gray-300"></div>
            <p className="text-sm text-[#8EA7E9]">Login with social accounts</p>
            <div className="flex-1 h-px bg-gray-300"></div>
        </div>
        {/* Social icons */}
        <div className="flex justify-center space-x-6 mt-3">
         
         <button aria-label="Log in with Google" className="p-3 rounded-full hover:bg-[#8EA7E9]">
            ...
            <button aria-label="Log in with Twitter" className="p-3 rounded-full hover:bg-[#8EA7E9]">
            ...
            <button aria-label="Log in with GitHub" className="p-3 rounded-full hover:bg-[#8EA7E9]">
