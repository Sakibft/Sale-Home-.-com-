  ...
  return (
    <div>
      ...
      <footer className="flex flex-col text-black">
            <div className="flex flex-col items-center justify-around gap-5 bg-blue-50 py-8 md:flex-row md:gap-0">
                <aside className="flex items-center justify-center gap-3 text-xl">
                <IoHome className="text-6xl"/>

                    <p className="text-3xl mt-2">Home Sale</p>
                </aside>
            ...
            <aside className="bg-sky-100 py-5 text-center text-sm">
                <p>&copy; 2024 Sale ~ home. All Rights Reserved.</p>
            </aside>
        </footer>
